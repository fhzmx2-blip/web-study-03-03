					...
					<table class="table">
						<tbody>
							...
							<tr>
								...
								<td width="85%">
								<input type=text name=subject size=50 class="input-sm" required value="<%=vo.getSubject() %>">
								</td>
							</tr>
							<tr>
								<th width="15%" class="text-center">내용</th>
								<td width="85%">
								<textarea rows="10" cols="52" required name=content required name=content><%=vo.getContent() %></textarea>
								</td>
							</tr>
							<tr>
