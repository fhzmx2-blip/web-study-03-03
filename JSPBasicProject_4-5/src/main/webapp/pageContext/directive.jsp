...
<body>
	<div class="container">
		<div class="row">
			...
			<table class="table">
				<tr>
					<td colspan="2">JSP에서 파일(페이지)에 대한 전반적인 설절이나 동작방식을 지시하는 명령문</td>
				</tr>
				<tr>
					<td colspan="2">지시자의 종류</td>
				</tr>
				<tr>
					<td>**page</td>
			...
			<table class="table">
				<tr>
					<td colspan="3">기본형태 : &lt;%@ page 속성="값" ... %&gt; <br>
						속성="값" 반드시 ""
					</td>
				</tr>
				<tr>
					...
					<td>html:text/html;charset=UTF-8 <br> xml:
						text/xml;charset=UTF-8 <br> json: text/plain;charset=UTF-8
					</td>
				</tr>
				<tr>
					<td>import</td>
